...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    if([segue.identifier isEqualToString:@"SixToSeven"]){
        self.data.Global_Uni_Word = self.uni_text.text;
        self.data.Global_Uni_Image = self.imageField.image;
        tenViewController*vc6_7 = segue.destinationViewController;
        vc6_7.data = self.data;
    }
}
